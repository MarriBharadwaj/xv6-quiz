...
Definition: System calls are low-level interfaces to the operating system kernel. They provide a way for user-level processes to request services from the operating system.
